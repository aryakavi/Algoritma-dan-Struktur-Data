...
public class MahasiswaDemo04 {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("5. Melihat Tugas Terbawah (Pertama Dikumpulkan)"); // Tambahan No. 4
            System.out.println("6. Melihat Jumlah Tugas Saat Ini"); // Tambahan No. 5
